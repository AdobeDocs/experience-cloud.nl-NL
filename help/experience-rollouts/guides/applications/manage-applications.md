...
Een **toepassing** in de Rollouts van de Ervaring vertegenwoordigt de dienst of het product u met eigenschapvlaggen wilt controleren. Voordat uw team functiemarkeringen kan maken, moet u ten minste één toepassing aan boord van de console hebben.

## Wie kan toepassingen beheren? {#permissions}

Slechts kunnen de leden met de **Admin** rol toepassingen toevoegen of wijzigen. Als u deze rol niet hebt, neemt u contact op met uw teambeheerder.
...
Elke toepassing is eigendom van exact één team. Alleen leden van dat team kunnen de functiemarkeringen van de toepassing beheren.
