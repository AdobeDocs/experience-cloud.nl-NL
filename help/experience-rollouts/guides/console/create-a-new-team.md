---
title: Een nieuw team maken
description: Leer hoe u in Adobe Experience Rollouts een nieuw team kunt aanvragen als er nog geen team voor uw project bestaat.
...
# Een nieuw team maken {#create-a-new-team}

Als er geen team voor uw project bestaat in Experience Rollouts, moet u er een aanvragen voordat u functiemarkeringen kunt gaan maken. De verwezenlijking van het team wordt behandeld door een steunverzoek.
...
De steun van Rollouts van de Ervaring van het contact om een nieuw team te verzoeken. Geef de volgende informatie op in uw verzoek:
...
>[!NOTE]
>
>Teambeheerders zijn verantwoordelijk voor het beheren van leden en het goedkeuren van toegangsverzoeken. Wijs ten minste twee beheerders aan om tussenruimten in de toegang te voorkomen als één beheerder niet beschikbaar is.

## Nadat het team is gemaakt {#after-creation}
...
* [Teams en hun beheerders](teams-and-admins.md)
